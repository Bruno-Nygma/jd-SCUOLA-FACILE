        ...
        return jd.tr({ ref: trRef }, [
            jd.th({}, [
                jd.label({}, [
                    jd.input({
                        ...
                        onchange: (e) => {
                            setStudentsList(studentsList().map(st => st.id === student.id ? { ...student, checked: e.target.checked } : st))
                        }
                    })
                ]),
            ]),
            jd.td({}, [
                jd.div({ className: "flex items-center gap-3" }, [
                    ...
                    jd.div({}, [
                        jd.div({ className: "font-bold" }, [` ${student.name} ${student.surname}`]),
                        jd.div({ className: "text-sm opacity-50" }, [student.email]),
                    ]),
                ]),
            ]),
            jd.td({}, [student.course]),
            jd.td({}, [
                jd.progress({
            ...
            jd.th({}, [
                ...
                DeleteDialog({
                    ...
                    description: `Sicuro di voler eliminare lo studente ${student.name}?`,
                    trigger: jd.button(
                        {
